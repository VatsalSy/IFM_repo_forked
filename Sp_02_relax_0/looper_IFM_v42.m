...
while delta_theta_c_too_large
    ...
    for it = 1:n_steps
        ...
        if theta_m > change
            ...
            R = Res_finder_Euler_A_v42(n_v_near,n_p_near,n_spines_near, ...
            ...
            x = [u_bar(unodes_nums_uk_near); ...
                 ...
                 theta_c]; 
            %Finding initial residual
            R = Res_finder_Euler_noA_v42(n_v_near,n_p_near, ...
                      n_spines_near, ...
                      n_v_far,n_p_far,n_spines_far, ...
                      theta_c, ...
                      u_bar,w_bar,p, ...
        ...
        while norm_R > tol_R %|| norm_err > tol_err
            ...
            if theta_m > change
                %Finding Jacobian
                JR = Jacobian_finder_Euler_A_v42(n_v_near,n_p_near, ...
                                n_spines_near, ...
                                n_spines_far, ...
                ...
                %Finding Jacobian
                JR = Jacobian_finder_Euler_noA_v42(n_v_near,n_p_near, ...
                                n_spines_near, ...
                                n_spines_far, ...
                                n_lambda2_uk_near,n_sigma2_uk_near, ...
                                n_v_sep,n_v_far,n_p_far, ...
