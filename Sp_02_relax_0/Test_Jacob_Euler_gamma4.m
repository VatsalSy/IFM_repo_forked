...
for count = 1:length_of_var
    ...
    aux_store = gamma4(count);
    gamma4(count) = gamma4(count) + pert;
...
title('Relative error in $\partial_{\gamma^{4}}$', ...
      'interpreter','latex','FontSize',16)
subplot(1,2,2)
surf((rel_err>1E-4) ...
     .*abs(aux1-aux2),...
     'LineStyle','none','FaceColor','interp')
title(['Absolute error of $\partial_{\gamma^{4}}$ ', ...
