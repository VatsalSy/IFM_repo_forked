...
length_of_var = n_lambda2_uk_near;
pert = .001;
...
if theta_m > change  
    for count = 1:length_of_var
        ...
        aux_store = lambda2(count);
        lambda2(count) = lambda2(count) + pert;
...
title('Relative error in $\partial_{\lambda^2_{near}}$', ...
      'interpreter','latex','FontSize',16)
subplot(1,2,2)
surf((rel_err>1E-4) ...
     .*abs(aux1-aux2),...
     'LineStyle','none','FaceColor','interp')
title(['Absolute error of $\partial_{\lambda^2_{near}}$ ', ...
