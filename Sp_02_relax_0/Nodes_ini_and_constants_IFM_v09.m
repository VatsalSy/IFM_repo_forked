...
spine_factor_r =  1.07;%1.15;%;%needs to be slightly bigger than 1     1.05;%
save('spine_factor_r.mat','spine_factor_r')
n_spines_r = 15;% 5;% must be an odd number          5;%
save('n_spines_r.mat','n_spines_r')

spine_factor_mr = 1.07;%                   2;%   
save('spine_factor_mr.mat','spine_factor_mr')
n_spines_mr = 21;% 5;% must be an odd number        
...
spine_factor_m = 1.1;%                   2;%   
save('spine_factor_m.mat','spine_factor_m')
n_spines_m = 105;% 5;% must be an odd number        
...
tau_g_dim = 0*rho_dim*nu_dim*7E-6;
...
save('Tg.mat','Tg')
%ratio of interface width to typical length
Lg = (Tg~=0)*width_dim/L_dim
save('Lg.mat','Lg')
...
l_min = min([5/(100*Bg) 1/Be  Ts*Ca/10])/(factor );% .05;% following J&Y IJFNMF 2012 
