...
max_delta_theta = .1*pi/180;

min_delta_theta = .01*pi/180;
...
for it = it_start_hs+1:it_start_hs+n_steps
    ...
    if theta_m > change
        x = [u_bar(unodes_nums_uk_near); ...
             ...
             theta_c; ...
             A]; 
        R = Res_finder_BDF2_A_v43(n_v_near,n_p_near,n_spines_near, ...
        ...
        x = [u_bar(unodes_nums_uk_near); ...
             ...
             sigma1(sigma1nodes_nums_uk_far); ...
             theta_c]; 
        R = Res_finder_BDF2_noA_v43(n_v_near,n_p_near,n_spines_near, ...
                         n_v_far,n_p_far,n_spines_far, ...
                         theta_c, ...
                         u_bar,w_bar,p, ...
                         lambda2,us2,ws2,rhos2,sigma2, ...
    ...
    while norm_R > tol_R %|| norm_err > tol_err
        ...
        if theta_m > change
            %Finding Jacobian
            JR = Jacobian_finder_BDF2_A_v43(n_v_near,n_p_near, ...
                       n_spines_near, ...
                       n_spines_far, ...
            ...
            %Finding Jacobian
            JR = Jacobian_finder_BDF2_noA_v43(n_v_near,n_p_near, ...
                           n_spines_near, ...
                           n_spines_far, ...
                           n_lambda2_uk_near,n_sigma2_uk_near, ...
                           n_v_sep,n_v_far,n_p_far, ...
