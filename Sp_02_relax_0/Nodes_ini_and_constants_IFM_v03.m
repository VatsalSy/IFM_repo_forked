...
l_min = min(1,5E-3/Ca)/(1000*Be);% .0005;% following J&Y IJFNMF 2012 
...
n_spines_r = 25;% 5;% must be an odd number         
...
n_spines_m = 41;% 7;% 5;% must be an odd number        
