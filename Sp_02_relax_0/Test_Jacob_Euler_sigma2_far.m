...
length_of_var = n_sigma2_uk_far-1;
pert = .00001;
...
if theta_m > change  
    for count = 1:length_of_var
        ...
        aux_store = sigma2(n_spines_near+count);
        sigma2(n_spines_near+count) = sigma2(n_spines_near+count) + pert;
        ...
        sigma2(n_spines_near+count) = aux_store;
...
title('Relative error in $\partial_{\sigma^{2}_{far}}$', ...
      'interpreter','latex','FontSize',16)
subplot(1,2,2)
surf((rel_err>1E-4) ...
     .*abs(aux1-aux2),...
     'LineStyle','none','FaceColor','interp')
title(['Absolute error of $\partial_{\sigma^{2}_{far}}$ ', ...
