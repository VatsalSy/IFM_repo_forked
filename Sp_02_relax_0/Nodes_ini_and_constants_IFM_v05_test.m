...
l_min = .05;%min([5/(100*Bg) 1/Be  Ts*Ca/10])/(2^6 );%  following J&Y IJFNMF 2012 
...
n_spines_mr = 5;% 5;% must be an odd number        
...
n_spines_m = 5;% 5;% must be an odd number        
