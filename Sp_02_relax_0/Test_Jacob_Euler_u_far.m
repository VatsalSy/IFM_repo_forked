...
if theta_m > change  
    for count = 1:length_of_var
        ...
        aux_store = u_far(unodes_nums_uk_far(count)-n_v_pre_start_far);
        u_far(unodes_nums_uk_far(count)-n_v_pre_start_far) = ...
            u_far(unodes_nums_uk_far(count)-n_v_pre_start_far) + pert;
        ...
        u_far(unodes_nums_uk_far(count)-n_v_pre_start_far) = aux_store;
...
title('Relative error in $\partial_{u_{far}}$', ...
      'interpreter','latex','FontSize',16)
subplot(1,2,2)
surf((rel_err>1E-4) ...
     .*abs(aux1-aux2),...
     'LineStyle','none','FaceColor','interp')
title(['Absolute error of $\partial_{u_{far}}$ ', ...
