...
load('unodes_nums_uk_mixed.mat')
load('wnodes_nums_uk_mixed.mat')
load('unodes_nums_uk_unmixed_far.mat')
load('wnodes_nums_uk_unmixed_far.mat')
load('pnodes_nums_uk_mixed.mat')
load('pnodes_nums_uk_unmixed_far.mat')
load('pNodes_rz.mat')
load('n_p.mat')
load('n_p_near.mat')
load('n_p_far.mat')
...
load('alpha_4.mat')
load('alpha_5.mat')
load('Mr_nodes_mixed.mat')
load('Mr_nodes_unmixed_far.mat')
load('Mz_nodes_mixed.mat')
load('Mz_nodes_unmixed_far.mat')
load('C_nodes_mixed.mat')
load('C_nodes_unmixed_far.mat')
load('n_Mr_mixed.mat','n_Mr_mixed')
load('n_Mz_mixed.mat','n_Mz_mixed')
load('n_Mr_unmixed_far.mat','n_Mr_unmixed_far')
load('n_Mz_unmixed_far.mat','n_Mz_unmixed_far')
load('n_C_mixed.mat','n_C_mixed')
load('n_C_unmixed_far.mat','n_C_unmixed_far')
...
% rhos1_minus2 = Dg*ones(n_spines,1);
...
for count = 1:length_of_var
    ...
    aux_store = lambda4(count);
    lambda4(count) = lambda4(count) + pert;
    
    %%%%%%%%%%%%%%%%%%%%%%%%
    R = Res_finder_Euler_v12(n_v_near,n_p_near,n_spines_near, ...
                         ...
                         theta_a, ...
                         l_3,l3_3,phi3_xi_lG,phi3_lG,alpha_3, ...
                         lambda3,gamma3,alpha_5,So, ...
                         ...
                         n_S2_far,n_I_far,n_E2_far,n_D2_far,n_T2_far, ...
                         n_S1_far,n_K_far,n_E1_far,n_D1_far,n_T1_far, ...
                         Mr_nodes_near,Mz_nodes_near,C_nodes_near, ...
                         S2_nodes_near,I_nodes_near,E2_nodes_near,D2_nodes_near,T2_nodes_near, ...
                         S1_nodes_near,K_nodes_near,E1_nodes_near,D1_nodes_near,T1_nodes_near, ...
                         Mr_nodes_far,Mz_nodes_far,C_nodes_far, ...
                         S2_nodes_far,I_nodes_far,E2_nodes_far,D2_nodes_far,T2_nodes_far, ...
                         S1_nodes_far,K_nodes_far,E1_nodes_far,D1_nodes_far,T1_nodes_far, ...
                         Tmat1,Tmat2,Tmat3,Tmat4,Tmat5, ...
                         LE_to_TE_1,LE_to_TE_2,LE_to_TE_3,LE_to_TE_4,LE_to_TE_5, ...
                         n5_el,l_5,l5_5,phi5_lG,phi5_eta_lG, ...
                         a1,o2);
                     
    R_forw(:,count) = R;%#ok
        
    lambda4(count) = aux_store;
...
JR = Jacobian_finder_Euler_v12(n_v_near,n_p_near,n_spines_near, ...
                                    n_spines_far, ...
                                    ...
                                    n_us1_uk_far,n_ws1_uk_far,n_rhos1_uk_far,n_sigma1_uk_far, ...
                                    unodes_nums_uk_near,wnodes_nums_uk_near,pnodes_nums_uk_near, ...
                                    lambda2nodes_nums_uk_near,us2nodes_nums_uk_near, ...
                                    ws2nodes_nums_uk_near,n_sigma1_uk_near, ...
                                    ...
                                    Tmat1,Tmat2,Tmat3,Tmat4,Tmat5, ...
                                    LE_to_TE_1,LE_to_TE_2,LE_to_TE_3,LE_to_TE_4,LE_to_TE_5, ...
                                    n5_el,l_5,l5_5,phi5_lG,phi5_eta_lG,S_5, ...
                                    el5_s_loc_nodes, ...
                                    us1nodes_nums_uk_near, ...
                                    ws1nodes_nums_uk_near,D2_nodes_near, ...
...
title('Relative error in $\partial_{\lambda^{4}}$', ...
      'interpreter','latex','FontSize',16)
subplot(1,2,2)
surf((rel_err>1E-4) ...
     .*abs(aux1-aux2),...
     'LineStyle','none','FaceColor','interp')
title(['Absolute error of $\partial_{\lambda^{4}}$ ', ...
