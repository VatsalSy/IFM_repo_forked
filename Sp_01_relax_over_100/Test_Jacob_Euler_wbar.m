...
if theta_m > change  
    for count = 1:length_of_var
        ...
        aux_store = w_bar(count);
        w_bar(count) = w_bar(count) + pert;
...
%%
%w_bar
aux1 = JR(:,n_u_uk_near+1:n_u_uk_near+n_w_uk_near);
aux2 = diff_num;
...
title('Relative error in $\partial_{\bar{w}}$', ...
      'interpreter','latex','FontSize',16)
subplot(1,2,2)
surf((rel_err>1E-4) ...
     .*abs(aux1-aux2),...
     'LineStyle','none','FaceColor','interp')
title(['Absolute error of $\partial_{\bar{w}}$ ', ...
