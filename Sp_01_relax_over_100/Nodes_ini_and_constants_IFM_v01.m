...
theta_c_ini = 170*pi/180; %radians 
...
l_min = min(1,5E-3/Ca)/(1000*Be);% .005;% following J&Y IJFNMF 2012 
...
spine_factor_r =  1.15;%1.15;%;%needs to be slightly bigger than 1     1.05;%
save('spine_factor_r.mat','spine_factor_r')
n_spines_r = 25;% 5;% must be an odd number          5;%
...
spine_factor_m = 1.2;%                   2;%   
save('spine_factor_m.mat','spine_factor_m')
n_spines_m = 21;% 5;% must be an odd number        
...
spine_factor_l = 1.15;% 1.11;% this needs to be slightly bigger than 1, James' value = 1.07
save('spine_factor_l.mat','spine_factor_l')
n_spines_l = 25;% 5;% must be an odd number        5;% 
...
%each row is a node and they are listed in order)
