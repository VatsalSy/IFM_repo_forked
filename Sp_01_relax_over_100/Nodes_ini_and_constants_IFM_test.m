...
%z-traslation for the centr e of the sphere
...
l_min = .03;% .005;% min(1,5E-3/Ca)/(1000*Be);% following J&Y IJFNMF 2012 
...
n_spines_r = 15;% 25;% must be an odd number          5;%
...
spine_factor_m = 1.25;%                   2;%   
save('spine_factor_m.mat','spine_factor_m')
n_spines_m = 3;% 25;% must be an odd number        
