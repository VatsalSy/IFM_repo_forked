...
length_of_var = n_p_uk_far-n_p_sep;
pert = .0001;
...
if theta_m > change  
    for count = 1:length_of_var
        ...
        aux_store = p(pnodes_nums_uk_far(n_p_sep+count));
        p(pnodes_nums_uk_far(n_p_sep+count)) = p(pnodes_nums_uk_far(n_p_sep+count)) + pert;
        ...
        p(pnodes_nums_uk_far(n_p_sep+count)) = aux_store;
...
title('Relative error in $\partial_{p_{far}}$', ...
      'interpreter','latex','FontSize',16)
subplot(1,2,2)
surf((rel_err>1E-4) ...
     .*abs(aux1-aux2),...
     'LineStyle','none','FaceColor','interp')
title(['Absolute error of $\partial_{p_{far}}$ ', ...
