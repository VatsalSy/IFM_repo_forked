%This is the same as version 1 but with a finner spatial mesh
...
load('Re.mat');%Re = U_dim*L_dim/nu_dim; %Reynolds number1

save(['delta_t_hs_',num2str(hs),'.mat'],'delta_t')
...
while delta_theta_c_too_large
    ...
    w_bar = zeros(n_v_near,1); % -1*(1-exp(-Nodes_rz(1:n_v_near,2)));%
    u_far = zeros(n_v-n_v_pre_start_far,1);
    w_far = zeros(n_v-n_v_pre_start_far,1);% -1*(1-exp(-Nodes_rz(n_v_start_far:end,2)));%

    u_minus1 = zeros(n_v,1);
    % u_minus2 = u_minus1;
    w_minus1 = zeros(n_v,1);% -1*(1-exp(-Nodes_rz(:,2)));%
    % w_minus2 = w_minus1;
    ...
    us1 = zeros(n_spines,1);
    save('us1_0.mat','us1')
    ws1 = zeros(n_spines,1);
    save('ws1_0.mat','ws1')
    rhos1 = Dg*ones(n_spines,1);
    save('rhos1_0.mat','rhos1')
    rhos1_minus1 = Dg*ones(n_spines,1);
    % rhos1_minus2 = Dg*ones(n_spines,1);
    sigma1 = ones(n_spines,1);
    save('sigma1_0.mat','sigma1')
    pg = zeros(n_spines,1);

    lambda2 = zeros(n_spines,1);
    us2 = zeros(n_spines,1);
    save('us2_0.mat','us2')
    ws2 = zeros(n_spines,1);
    save('ws2_0.mat','ws2')
    sigma2 = ones(n_spines,1);
    sigma2(c2) = So - sigma1(c1)*cos(theta_c_ini);
    sigma2 = sigma2(c2)*ones(n_spines,1);
    save('sigma2_0.mat','sigma2')
    rhos2 = ones(n_spines,1)-sigma2/Cs;
    rhos2_minus1 = rhos2;
    ...
    theta_c_vec = zeros(1,n_steps+1);
    theta_m_vec = zeros(1,n_steps+1);
    theta_c_vec(1) = theta_c_ini;
    theta_m_vec(1) = theta_m;
    save('theta_c_vec.mat','theta_c_vec')
    save('theta_m_vec.mat','theta_m_vec')
    U_cl_vec = zeros(1,n_steps+1);
    U_cl_vec(1) = 0;
    save('U_cl_vec.mat','U_cl_vec')

    theta_of_U_cl = figure;
    load('U_dim.mat')
    plot(U_cl_vec(1)*U_dim,theta_c_vec(1)*180/pi,'-x', ...
    ...
    for it = 1:n_steps
        ...
        disp(['fraction of sim = ',num2str(it/n_steps)])
        ...
        if theta_m > change
            x = [u_bar(unodes_nums_uk_near); ...
                 ...
                 theta_c; ...
                 A];
            %Finding initial residual
            R = Res_finder_Euler_A_v43(n_v_near,n_p_near,n_spines_near, ...
                      ...
                      n_el,n_p_pre_start_far,n1_el,n2_el, ...
                      n3_el, ...
                      ...
                      S2_nodes_near,I_nodes_near,E2_nodes_near, ...
                      D2_nodes_near,T2_nodes_near, ...
                      S1_nodes_near,K_nodes_near,E1_nodes_near, ...
                      D1_nodes_near,T1_nodes_near, ...
                      Mr_nodes_far,Mz_nodes_far,C_nodes_far, ...
                      S2_nodes_far,I_nodes_far,E2_nodes_far, ...
                      D2_nodes_far,T2_nodes_far, ...
                      S1_nodes_far,K_nodes_far,E1_nodes_far, ...
            ...
            x = [u_bar(unodes_nums_uk_near); ...
                 ...
                 theta_c]; 
            %Finding initial residual
            R = Res_finder_Euler_noA_v43(n_v_near,n_p_near, ...
                      n_spines_near, ...
                      n_v_far,n_p_far,n_spines_far, ...
                      theta_c, ...
                      u_bar,w_bar,p, ...
        ...
        while norm_R > tol_R %|| norm_err > tol_err
            ...
            if theta_m > change
                %Finding Jacobian
                JR = Jacobian_finder_Euler_A_v43(n_v_near,n_p_near, ...
                                n_spines_near, ...
                                n_spines_far, ...
                ...
                %Finding Jacobian
                JR = Jacobian_finder_Euler_noA_v43(n_v_near,n_p_near, ...
                                n_spines_near, ...
                                n_spines_far, ...
                                n_lambda2_uk_near,n_sigma2_uk_near, ...
                                n_v_sep,n_v_far,n_p_far, ...
            ...
            [Nodes_rz,~] ...
                    = nodes_relocator_split_v02(spine_lengths, ...
                                            ...
                                            n_nodes_const_per_spine, ...
                                            n_el_sing);
            %Measured contact anglenodes_re
            r_le = Nodes_rz(l_1(1,:),1);
            z_le = Nodes_rz(l_1(1,:),2);
            min_r_le = min(r_le);
            min_z_le = min(z_le);
            ...
            disp(['U_cl = ',num2str((  Nodes_rz(1,1) ...
                                     - Nodes_rz_minus1(1,1) ...
                                    ) ...
                                    *U_dim ...
                                    /delta_t ...
        ...
        U_cl_vec(it+1) = (Nodes_rz(1,1)-Nodes_rz_minus1(1,1))/delta_t;
        save('theta_c_vec.mat','theta_c_vec')
        save('U_cl_vec.mat','U_cl_vec')

        disp(['U_cl = ',num2str((Nodes_rz(1,1)-Nodes_rz_minus1(1,1))*U_dim/(delta_t)), 'm/s'])
        ...
        plot(U_cl_vec(1:it+1)*U_dim,theta_c_vec(1:it+1)*180/pi,'-x', ...
             'LineWidth',2,'MarkerSize',6)
        set(gca,'FontSize',16)
        ylabel('[$^o$]   ','interpreter','latex','rotation',0,'FontSize',24)
        xlabel('m/s','interpreter','latex','FontSize',24)
    ...
    if abs(theta_c-theta_c_ini) > max_delta_theta
        delta_t = delta_t/2;
    else
        delta_theta_c_too_large = false;
