...
n_el = n_el_incr ...
       + (n_spines-n_spines_incr)*(2*n_el_sing+n_spines_incr-4)/2; %the 
...
if n_spines_near > n_spines_incr
    ...
    n_v_start_far = n_v_near - n_nodes_const_per_spine + 1;
    n_v_far = n_v - n_v_near + n_nodes_const_per_spine;
    %Calculating the number of elements in the near field region
    n_el_near = n_el_sing ...
                + ((1+n_spines_incr-2)/2)*(n_spines_incr-1)/2 ...
