...
if theta_m > change  
    for count = 1:length_of_var
        ...
        aux_store = rhos2(count);
        rhos2(count) = rhos2(count) + pert;
...
title('Relative error in $\partial_{\rho^{s_2}_{near}}$', ...
      'interpreter','latex','FontSize',16)
subplot(1,2,2)
surf((rel_err>1E-4) ...
     .*abs(aux1-aux2),...
     'LineStyle','none','FaceColor','interp')
title(['Absolute error of $\partial_{\rho^{s_2}_{near}}$ ', ...
