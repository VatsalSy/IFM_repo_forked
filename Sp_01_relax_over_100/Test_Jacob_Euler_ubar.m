...
if theta_m > change  
    for count = 1:length_of_var
        ...
        aux_store = u_bar(count);
        u_bar(count) = u_bar(count) + pert;
...
%%
%u_bar
%relative error in diff_u_bar_near_Cu Jacobian
aux1 = JR(:,1:n_u_uk_near);
aux2 = diff_num;
...
title('Relative error in $\partial_{\bar{u}}$', ...
      'interpreter','latex','FontSize',16)
subplot(1,2,2)
surf((rel_err>1E-4) ...
     .*abs(aux1-aux2),...
     'LineStyle','none','FaceColor','interp')
title(['Absolute error of $\partial_{\bar{u}}$ ', ...
...
vector_of_eqns = ['End_Mr_bar = ',num2str(n_Mr_near),', ', ...
                  ...
                  'End_Y = ',num2str((n_Mr_near+n_Mz_near+n_C_near ...
                   ...
                   +2*n_v_sep ...
                   +n_Mr_far+n_Mz_far+n_C_far-n_p_sep ...
                   +9*(n_spines_far-1)+n_K_far-1-2)+1),', ', ...
                   'End_Cp = ',num2str((n_Mr_near+n_Mz_near+n_C_near ...
                   +n_S2_near+n_I_near+n_E2_near+n_D2_near+n_T2_near ...
                   +n_S1_near+n_K_near+n_E1_near+n_D1_near+n_T1_near ...
                   +2*n_v_sep ...
                   +n_Mr_far+n_Mz_far+n_C_far-n_p_sep ...
                   +9*(n_spines_far-1)+n_K_far-1-2)+2)]%#ok
