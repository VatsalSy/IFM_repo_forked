...
theta_c_ini = 135*pi/180; %radians 
...
n_spines_mr = 25;% 5;% must be an odd number        
...
n_spines_m = 95;% 5;% must be an odd number        
...
n_spines_l = 23;% 5;% must be an odd number        5;% 
