...
length_of_var = n_sigma1_uk_near;
pert = .0001;
...
if theta_m > change  
    for count = 1:length_of_var
        ...
        aux_store = sigma1(count);
        sigma1(count) = sigma1(count) + pert;
    ...
    for count = 1:length_of_var
        ...
        R = Res_finder_Euler_noA_v39(n_v_near,n_p_near,n_spines_near, ...
                      n_v_far,n_p_far,n_spines_far, ...
                      theta_c, ...
                      u_bar,w_bar,p, ...
                      lambda2,us2,ws2,rhos2,sigma2, ...
...
if theta_m > change
    ...
    JR = Jacobian_finder_Euler_noA_v39(n_v_near,n_p_near,n_spines_near, ...
                n_spines_far, ...
                n_lambda2_uk_near,n_sigma2_uk_near, ...
                n_v_sep,n_v_far,n_p_far, ...
                theta_c,del_h, ...
...
title('Relative error in $\partial_{\sigma^{1}_{near}}$', ...
      'interpreter','latex','FontSize',16)
subplot(1,2,2)
surf((rel_err>1E-4) ...
     .*abs(aux1-aux2),...
     'LineStyle','none','FaceColor','interp')
title(['Absolute error of $\partial_{\sigma^{1}_{near}}$ ', ...
