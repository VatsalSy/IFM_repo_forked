...
n_spines_near = n_spines_r;%This has to be an odd number
...
if n_spines_near > n_spines_incr
    ...
    n_el_near =  ((1+n_spines_incr-2)/2)*(n_spines_incr-1)/2 ...
               + (n_spines_near-n_spines_incr)*(n_spines_incr-1)/2;
    n_v_sep = n_spines_incr;
else
...
save('n_p.mat','n_p')
if n_spines_near > n_spines_incr
    n_p_near =  (n_spines_incr+3)*(n_spines_incr+1)/8 ...
              + (n_spines_near-n_spines_incr)*(n_spines_incr+1)/4;
    n_p_start_far  = n_p_near - (n_spines_incr+1)/2 + 1;
    n_p_far = n_p - n_p_near + (n_spines_incr+1)/2;
    n_p_uk_far = n_p-n_p_near+(n_spines_incr+1)/2;
    pnodes_nums_uk_far = n_p_near-(n_spines_incr+1)/2+1:n_p;
else
